...
#pearson correlation senseless when not normally distributed --> spearman, kendall
cor.test(TMEnoNA$activity, TMEnoNA$boldness, method="spearman")
...
summary(TMEday1$tonCeffect)
summary(TMEday2$tonCeffect)
summary(TMEday3$tonCeffect)

#H3:
res.man <- manova(cbind(activity, boldness)~tonCeffect,data=TMEnoNA)
summary.aov(res.man)
res.man1 <- manova(cbind(activity, boldness)~tonCeffect,data=TMEday1)
summary.aov(res.man1)
res.man2 <- manova(cbind(activity, boldness)~tonCeffect,data=TMEday2)
summary.aov(res.man2)
res.man3 <- manova(cbind(activity, boldness)~tonCeffect,data=TMEday3)
